...
exports.waitForDealWithConflict = exports.getToBePushed = exports.getUpstreamBranchName = exports.getCurrentBranchName = exports.gitMerge = exports.gitCheckout = exports.gitPush = exports.gitPull = exports.gitCommit = void 0;
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, exports.gitCommit("\u3010" + constants_1.Commit.EnumTypes.conflict + "\u3011\u5408\u5E76\u51B2\u7A81")];
            case 4:
                _b.sent();
                return [3 /*break*/, 6];
            case 5:
...
exports.gitMerge = function (targetBranch) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                currentBranch = _b.sent();
                return [4 /*yield*/, git_1.gitInSilent('merge', targetBranch, '--no-ff', '-m', "\u3010" + constants_1.Commit.EnumTypes.merge + "\u3011Merge branch '" + targetBranch + "' into '" + currentBranch + "'")];
            case 2:
                _a = _b.sent(), code = _a.code, message = _a.message;
                tips_1.tips.hideLoading();
                if (!(code !== promisify_spawn_1.CODE_SUCCESS && checkConflict(message))) return [3 /*break*/, 6];
