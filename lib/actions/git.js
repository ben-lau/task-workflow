...
exports.getLastCommit = exports.getRemoteUrl = exports.waitForDealWithConflict = exports.getToBePushed = exports.getUpstreamBranchName = exports.getCurrentBranchName = exports.gitMerge = exports.gitCheckout = exports.gitPush = exports.gitPull = exports.gitCommit = void 0;
    ...
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, git_1.gitInSilent('pull', '--rebase')];
            case 2:
 ...
 * 切换分支
 */
exports.gitCheckout = function (_a) {
 ...
 * 获取分支上游分支名
 */
exports.getUpstreamBranchName = function (_a) {
    var branch = _a.branch;
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var message;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, git_1.git('rev-parse', '--symbolic-full-name', branch + "@{u}")];
                case 1:
 ...
 * 获取分支上一次提交记录
 */
exports.getLastCommit = function (_a) {
    var branch = _a.branch;
    return tslib_1.__awaiter(void 0, void 0, void 0, function () {
