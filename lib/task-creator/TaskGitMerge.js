            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, git_1.gitCheckout({ branch: sourceBranch })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, git_1.gitCheckout({ branch: targetBranch })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, git_1.gitMerge({ branch: sourceBranch })];
                    case 3:
                        _a.sent();
